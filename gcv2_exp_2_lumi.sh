...
CONFIG_FILE="/project/project_462001066/exp_slotcontrast/configs/slotcontrast/ytvis2021.yaml"


CONFIGS=(
    # # ytvis2021
    # # DINO v2-base
    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.0 0.0"

    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.3 0.0 0.0"
    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.5 0.0 0.0"
    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 1.0 0.0 0.0"
    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 0.3 0.0 0.0"
    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 0.5 0.0 0.0"
    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 1.0 0.0 0.0"

    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.5 0.0"
    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 1.0 0.0"

    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.0 0.1"
    # "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.0 0.2"
    
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.05 0.0 0.0"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 0.05 0.0 0.0"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.05 0.0"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.05 0.0 0.05"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 0.05 0.0 0.05"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.05 0.05 0.0"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 0.05 0.05 0.0"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.05 0.05"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.05 0.05 0.05"
    "42 gcv2_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor false vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 0.05 0.05 0.05"
    
    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.0 0.0"

    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.3 0.0 0.0"
    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.5 0.0 0.0"
    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 1.0 0.0 0.0"
    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 0.3 0.0 0.0"
    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 0.5 0.0 0.0"
    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true true 1.0 0.0 0.0"

    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.5 0.0"
    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 1.0 0.0"

    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.0 0.1"
    # "42 gcv2_learnable_pos_emb_dinov2_block12 GreedyFeatureInit per_frame networks.HungarianPredictor true vit_block12 vit_block12 vit_base_patch14_dinov2 1369 518 768 utils.LearnedPositionEmbed true false 0.0 0.0 0.2"
...
for config in "${CONFIGS[@]}"; do
    read -r SEED exp_name init_name init_mode predictor use_pos_embed features main_features_key DINO_MODEL NUM_PATCHES input_size FEAT_DIM pos_embed use_hybrid_cost use_kalman lambda_pos lambda_iou lambda_angular <<< "$config"
    ...
    sbatch --job-name="sc_${exp_name}" lumi_slurm.sh "${CONFIG_FILE}" \
        ...
        "model.predictor.use_kalman=${use_kalman}" \
        "model.predictor.lambda_pos=${lambda_pos}" \
        "model.predictor.lambda_iou=${lambda_iou}" \
        "model.predictor.lambda_angular=${lambda_angular}" \
